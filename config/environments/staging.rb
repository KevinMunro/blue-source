BlueSource::Application.configure do
  ...
  # Uglifier mangle option messes with angular...
  ...
  #config.assets.precompile += ['directory.css', 'directory.js', 'welcome.css', 'welcome.js']
